...
(function () {
  ...
  function openModal(bal) {
    ...
    host.innerHTML = [
      '<style>',
      '#uc-first-topup, #uc-first-topup *{box-sizing:border-box;font-family:"Archivo",system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif}',
      '#uc-first-topup .backdrop{position:fixed;inset:0;background:rgba(3,9,11,.82);backdrop-filter:blur(8px);-webkit-backdrop-filter:blur(8px);z-index:99998;display:flex;align-items:center;justify-content:center;padding:20px;animation:uc-fade .22s ease}',
      ...
      '#uc-first-topup .modal{width:100%;max-width:480px;background:#071114;color:#F2F5F4;border:1px solid #1C2A2D;border-radius:12px;box-shadow:0 24px 60px rgba(0,0,0,.55);padding:24px;animation:uc-pop .28s cubic-bezier(.2,.7,.2,1)}',
      ...
      '#uc-first-topup .strip .bal{color:#F2F5F4}',
      ...
      '#uc-first-topup .chip{padding:12px 0;background:#03090B;border:1px solid #1C2A2D;border-radius:9px;color:#F2F5F4;font:600 14px "JetBrains Mono",ui-monospace,monospace;cursor:pointer;transition:all .12s;text-align:center}',
      '#uc-first-topup .chip:hover{border-color:#2b333a}',
      '#uc-first-topup .chip.sel{border-color:#DFFF00;background:rgba(223,255,0,.08);color:#fff}',
      '#uc-first-topup .custom{display:flex;align-items:center;gap:8px;background:#03090B;border:1px solid #1C2A2D;border-radius:9px;padding:8px 12px;margin-bottom:14px}',
      '#uc-first-topup .custom.sel{border-color:#DFFF00}',
      ...
      '#uc-first-topup .custom input{flex:1;background:transparent;border:0;color:#F2F5F4;font:500 14px "JetBrains Mono",monospace;outline:none;min-width:0;padding:6px 0}',
      '#uc-first-topup .note{color:#657172;font-size:11.5px;margin:0 0 16px}',
      '#uc-first-topup .btn{width:100%;padding:13px 16px;background:#DFFF00;color:#03090B;border:0;border-radius:9px;font:600 14px inherit;cursor:pointer;transition:filter .15s;border:0}',
      '#uc-first-topup .btn:hover:not(:disabled){filter:brightness(1.08)}',
      ...
      '#uc-first-topup .ar{border:1px solid #1C2A2D;border-radius:10px;padding:14px 16px;background:#050D0F}',
      ...
      '#uc-first-topup .ar-hd .rec{font:500 10px "JetBrains Mono",monospace;color:#DFFF00;background:rgba(223,255,0,.1);padding:2px 6px;border-radius:4px;letter-spacing:.08em}',
      '#uc-first-topup .togg{position:relative;width:36px;height:20px;background:#1C2A2D;border-radius:999px;border:0;cursor:pointer;transition:background .15s;flex-shrink:0}',
      '#uc-first-topup .togg::after{content:"";position:absolute;top:2px;left:2px;width:16px;height:16px;background:#657172;border-radius:50%;transition:all .18s}',
      '#uc-first-topup .togg.on{background:rgba(223,255,0,.25)}',
      '#uc-first-topup .togg.on::after{background:#DFFF00;transform:translateX(16px)}',
      ...
      '#uc-first-topup .ar-row select{background:#03090B;color:#F2F5F4;border:1px solid #1C2A2D;border-radius:5px;padding:3px 6px;font:500 12px "JetBrains Mono",monospace}',
      ...
      '@media(max-width:560px){#uc-first-topup .backdrop{padding:12px}#uc-first-topup .modal{padding:20px 16px;border-radius:12px}#uc-first-topup .chips{grid-template-columns:repeat(2,1fr)}#uc-first-topup h2{font-size:18px}#uc-first-topup .desc{font-size:13px}}',
      '@media(max-width:380px){#uc-first-topup .backdrop{padding:8px}#uc-first-topup .modal{padding:16px 14px}#uc-first-topup h2{font-size:16px}}',
      '</style>',
